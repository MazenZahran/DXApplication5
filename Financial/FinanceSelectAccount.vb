...
Public Class FinanceSelectAccount
    ...
    Private Sub SearchLookUpEdit3_EditValueChanged(sender As Object, e As EventArgs) Handles SearchLookUpEdit3.EditValueChanged, SearchLookUpEdit3.EditValueChanged
        If SearchLookUpEdit3.IsHandleCreated Then
            Try
    ...
    Private Sub SearchLookUpEdit2_EditValueChanged(sender As Object, e As EventArgs) Handles SearchLookUpEdit2.EditValueChanged
        If SearchLookUpEdit2.IsHandleCreated And AreaText.IsHandleCreated Then
            Try
    ...
    Private Sub gridView1_DoubleClick(ByVal sender As Object, ByVal e As EventArgs) Handles GridView1.DoubleClick
        ...
        If Me.TextEdit1.Text = "Home" Then
            Exit Sub
        End If
    ...
    End Sub
    Private Sub RepositoryEdit_ButtonClick_1(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        Dim AccNo As String
        AccNo = CStr(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "AccountKey").ToString)
    ...
    Private Sub GetAccountStatment()
        FinancialAccountingStatment.AccountKeyTextEdit.EditValue = CStr(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "AccountKey").ToString)
        'FinancialAccountingStatment.DockPanel1.Visibility = DevExpress.XtraBars.Docking.DockVisibility.Hidden
        FinancialAccountingStatment.Text = CStr(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "FullName").ToString)
        FinancialAccountingStatment.ShowDialog()
    End Sub
