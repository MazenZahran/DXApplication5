...
Public Class FinancialAccountingStatment
...
ByVal e As RowCellCustomDrawEventArgs) Handles GridView1.CustomDrawCell
    ...
    Private Sub ShowGridPreview()
        'Dim lnk As DevExpress.XtraPrinting.PrintableComponentLink = New DevExpress.XtraPrinting.PrintableComponentLink(New PrintingSystem())
        'lnk.Component = GridControl1
        'lnk.RtfReportHeader = "Mazen"
        'lnk.ShowPreview()
    End Sub
